...
//    private static final Decompressor INFLATE = Decompressor.deflate(true);
...
//        this.source = BinarySource.open(base.resolve(name + ".resources"));
...
//        Bytes compressed = source.readBytes(asset.sizeCompressed());
//        Bytes decompressed = compressed;
//
