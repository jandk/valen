...
public class RLEDecoder {
    ...
    public static byte[] decodeRLE(BetterBuffer buffer, int numJoints) {
        int size = Byte.toUnsignedInt(buffer.getByte());
